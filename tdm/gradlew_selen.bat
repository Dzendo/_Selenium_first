...
echo ERROR: JAVA_HOME не задан, и в вашем ПУТИ не удалось найти команду 'java'.
echo.
...
@rem повторно установите переменную GRADLE_EXIT_CONSOLE, если вам нужен код возврата _script_ вместо
